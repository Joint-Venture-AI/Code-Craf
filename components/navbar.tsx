      ...
      <div className='container mx-auto px-4'>
        <div className='flex items-center justify-between h-16'>
          ...
          <nav className='hidden md:flex items-center gap-8'>
            ...
            <Link
  href="#service" // Make sure this matches the target ID
  onClick={(e) => {
    e.preventDefault();
    const section = document.querySelector('#service'); // Use the correct selector with '#'
    if (section) {
      section.scrollIntoView({ behavior: "smooth" });
    }
  }}
...
<Link
  href="#portfolio" // Make sure this matches the target ID
  onClick={(e) => {
    e.preventDefault();
    const section = document.querySelector('#portfolio'); // Use the correct selector with '#'
    if (section) {
      section.scrollIntoView({ behavior: "smooth" });
    }
  }}
...
Portfolio
  ...
  onClick={(e) => {
    e.preventDefault();
    const section = document.querySelector('#about'); // Use the correct selector with '#'
    if (section) {
      section.scrollIntoView({ behavior: "smooth" });
    }
  }}
...
Teams
            ...
            <Link
  href="#contact" // Make sure this matches the target ID
  onClick={(e) => {
    e.preventDefault();
    const section = document.querySelector('#contact'); // Use the correct selector with '#'
    if (section) {
      section.scrollIntoView({ behavior: "smooth" });
    }
  }}
