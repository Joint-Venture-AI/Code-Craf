    ...
    <footer className="bg-gray-50 border-t border-gray-100">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-4">
              Top-rated Fiverr seller providing premium AI development services with 100% client satisfaction.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/services/ai-chatbots" className="text-gray-600 hover:text-purple-600 transition-colors">
                  AI Chatbots
                </Link>
              </li>
              <li>
                <Link
                  href="/services/gpt-integration"
              ...
              <li>
                <Link href="/services/ai-analytics" className="text-gray-600 hover:text-purple-600 transition-colors">
              ...
              <li>
                <Link href="/services/custom-ai" className="text-gray-600 hover:text-purple-600 transition-colors">
                  Custom AI Solutions
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="text-gray-600">5.0 Rating (120+ Reviews)</li>
              <li className="text-gray-600">Fast 2-Day Delivery</li>
        ...
        <div className="border-t border-gray-200 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-600 text-sm">© {new Date().getFullYear()} NexusAI. All rights reserved.</p>
          <div className="flex space-x-6 mt-4 md:mt-0">
            <Link href="/privacy" className="text-gray-600 hover:text-purple-600 transition-colors text-sm">
              Privacy Policy
            </Link>
