...
export default function ContactForm() {
  ...
  return (
    <motion.div
      className="max-w-md mx-auto bg-white rounded-lg p-6 shadow-sm border border-gray-100"
      ...
      {isSubmitted ? (
        ...
        <form onSubmit={handleSubmit}>
          <div className="space-y-4">
            ...
            <Button type="submit" className="w-full bg-[#1dbf73] hover:bg-[#19a463] text-white" disabled={isSubmitting}>
              {isSubmitting ? (
                <>
                  <svg
